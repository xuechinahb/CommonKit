...
class MainActivity : MVVMActivity<ActivityMainBinding>(R.layout.activity_main),
        BaseBindingAdapter.OnItemClickListener<MainActivity.Bean> {
    ...
    class SimpleListAdapter(context: Context, itemClickListener: OnItemClickListener<Bean>) :
            BaseBindingAdapter<Bean, Item1Binding>(context, R.layout.item_1, itemClickListener = itemClickListener) {
